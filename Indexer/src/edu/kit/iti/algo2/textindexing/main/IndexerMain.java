...
import edu.kit.iti.algo2.textindexing.alexdomge.indexer.IndexBuilder;
...
public class IndexerMain {
	...
	public static void main(String[] args) throws IOException {
		...
		InvertedIndexPickle.storeToGZipXml(out, index);
		InvertedIndexPickle.storeToXml(out, index);
	}
