...
public abstract class LanguageSpecific {
	...
	public abstract Collection<String> tokenizeAndClean(List<String> content);

	public boolean isStopWord(String s) {
		return stopwords.contains(s);
	}

	public static class GermangSpecific extends LanguageSpecific {

		@Override
		public Collection<String> tokenizeAndClean(List<String> content) {
			return content;
		}
	}

	public static class EnglishSpecific extends LanguageSpecific {

		public EnglishSpecific() {
			stopwords = new HashSet<>(Arrays.asList("a's", "able", "about",
					...
					"don't", "done", "down", "downwards", "during", "each",
					...
					"gotten", "greetings", "had", "hadn't", "happens",
					...
					"hopefully", "how", "howbeit", "however", "i'd", "i'll",
					...
					"latterly", "least", "less", "lest", "let", "let's",
